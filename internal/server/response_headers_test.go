...
func TestHandleErrorWithResponseHeaders(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			provider:   "provider-zen-1",
			requested:  "provider-zen-1/ds-flash-free",
			wantActual: map[string]string{"X-Actual-Provider": "provider-zen-1", "X-Requested-Model": "provider-zen-1/ds-flash-free"},
		},
		{
		...
		},
		{
			...
			provider:   "provider-zen-1",
			requested:  "provider-zen-1/ds-flash-free",
			wantActual: map[string]string{"X-Actual-Provider": "provider-zen-1"},
		},
	}

...
const (
	...
	semanticRerankRequestKey    semanticCacheKey = "rerank_request"
...
// CachedRerankRequest returns the cached canonical rerank request, if present.
func (env *WhiteBoxPrompt) CachedRerankRequest() *RerankRequest {
	req, _ := cachedSemanticValue[*RerankRequest](env, semanticRerankRequestKey)
	return req
}

...
type createWorkflowRequest struct {
	...
	Payload             workflow.Payload `json:"workflow_payload"`
}
...
func (h *Handler) CreateWorkflow(c *echo.Context) error {
	...
	version, err := h.workflows.Create(c.Request().Context(), workflow.CreateInput{
...
func (h *Handler) validateWorkflowGuardrails(payload workflow.Payload) error {

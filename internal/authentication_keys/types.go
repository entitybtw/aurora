...
// RateLimits defines optional per-key request and token limits.
type RateLimits = core.AuthKeyRateLimits
...
type AuthKey struct {
	...
	RateLimits       RateLimits `json:"rate_limits,omitempty" bson:"rate_limits,omitempty"`

...
func TestEncodeBatchValidatesID(t *testing.T) {
	...
	t.Run("empty batch id", func(t *testing.T) {
		_, err := encodeBatch(&StoredBatch{Batch: &core.BatchResponse{}})
		if err == nil {
...
func TestEncodeBatchPreservesRequestEndpointHints(t *testing.T) {
	raw, err := encodeBatch(&StoredBatch{
...
func TestEncodeBatchPreservesUserPath(t *testing.T) {
	raw, err := encodeBatch(&StoredBatch{
		Batch: &core.BatchResponse{
			ID: "batch_123",
		},
...
func TestEncodeBatchStripsGatewayOnlyMetadata(t *testing.T) {
...
func TestDecodeBatchSupportsLegacyPayloads(t *testing.T) {
...
func TestDecodeBatchRejectsLegacyPayloadWithoutID(t *testing.T) {

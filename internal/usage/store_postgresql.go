...
const usageInsertPrefix = `
		...
		pricing_source, pricing_version, pricing_resolved_at)
		VALUES `
...
func NewPostgreSQLStore(pool *pgxpool.Pool, retentionDays int) (*PostgreSQLStore, error) {
	...
	costMigrations := []string{
		...
		"ALTER TABLE usage ADD COLUMN IF NOT EXISTS pricing_source TEXT DEFAULT ''",
		"ALTER TABLE usage ADD COLUMN IF NOT EXISTS pricing_version TEXT DEFAULT ''",
		"ALTER TABLE usage ADD COLUMN IF NOT EXISTS pricing_resolved_at TIMESTAMPTZ",
	}

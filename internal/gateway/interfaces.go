...
type TranslatedRequestPatcher interface {
	...
	PatchChatResponse(ctx context.Context, resp *core.ChatResponse) (*core.ChatResponse, error)
	PatchResponsesResponse(ctx context.Context, resp *core.ResponsesResponse) (*core.ResponsesResponse, error)
}

...
// PrepareRerankRequest resolves workflow/model policy for a rerank request.
func (o *InferenceOrchestrator) PrepareRerankRequest(ctx context.Context, req *core.RerankRequest, meta RequestMeta) (*PreparedRerankRequest, error) {
	if req == nil {
	...
	ctx = o.WithCacheRequestContext(ctx, workflow)
	return &PreparedRerankRequest{Context: ctx, Request: req, Workflow: workflow}, nil
}
...
type translatedPrepareSpec[Req any, Prepared any] struct {
	...
	valid           func(Req) bool
	promptCache     func(*InferenceOrchestrator, Req, *core.Workflow)
...
var chatPrepareSpec = translatedPrepareSpec[*core.ChatRequest, *PreparedChatRequest]{
	...
	promptCache: func(o *InferenceOrchestrator, req *core.ChatRequest, workflow *core.Workflow) {
		o.ApplyPromptCache(req, workflow)
	},
...
var responsesPrepareSpec = translatedPrepareSpec[*core.ResponsesRequest, *PreparedResponsesRequest]{
	...
	promptCache:     nil, // Responses API does not support prompt caching yet
...
func prepareTranslated[Req any, Prepared any](
	...
	if spec.promptCache != nil {
		spec.promptCache(o, req, workflow)
	}
...
func (o *InferenceOrchestrator) patchChatResponse(ctx context.Context, resp *core.ChatResponse) (*core.ChatResponse, error) {
	if o == nil || o.translatedRequestPatcher == nil {
		return resp, nil
	}
	return o.translatedRequestPatcher.PatchChatResponse(ctx, resp)
}

func (o *InferenceOrchestrator) patchResponsesResponse(ctx context.Context, resp *core.ResponsesResponse) (*core.ResponsesResponse, error) {
	if o == nil || o.translatedRequestPatcher == nil {
		return resp, nil
	}
	return o.translatedRequestPatcher.PatchResponsesResponse(ctx, resp)
}
...
func ApplyResolvedSelector(model, providerHint *string, resolution *core.RequestModelResolution) {
	...
	if preserveRequestedModelForUpstream() {
		if requestedModel := strings.TrimSpace(resolution.RequestedQualifiedModel()); requestedModel != "" {

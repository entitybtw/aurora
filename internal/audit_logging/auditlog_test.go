...
func (l *capturingLogger) BroadcastLive(*LogEntry) {}

func (l *capturingLogger) SubscribeLive(_ int) *LogSubscriber {
	ch := make(chan *LogEntry, 1)
	close(ch)
	return &LogSubscriber{ID: "capture", Entries: ch}
}

func (l *capturingLogger) UnsubscribeLive(_ string) {}

func (l *capturingLogger) LiveSubscriberCount() int { return 0 }

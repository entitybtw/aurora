...
type PromptCacheConfig struct {
	Mode                 string `yaml:"mode" env:"PROMPT_CACHE_MODE"`
	SystemPromptCache    bool   `yaml:"system_prompt" env:"PROMPT_CACHE_SYSTEM_PROMPT"`
	FirstMessageCache    bool   `yaml:"first_message" env:"PROMPT_CACHE_FIRST_MESSAGE"`
	ToolsCache           bool   `yaml:"tools" env:"PROMPT_CACHE_TOOLS"`
	MinTokensBeforeCache int    `yaml:"min_tokens" env:"PROMPT_CACHE_MIN_TOKENS"`
}
...
// CacheConfig holds model, response, and prompt cache configuration.

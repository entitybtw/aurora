...
import { Assign, Constrain, ConstrainLiteral, Expand, NoInfer } from './utils.cjs';
...
export declare function getRouteApi<TId, TRouter extends AnyRouter = RegisteredRouter>(id: ConstrainLiteral<TId, RouteIds<TRouter['routeTree']>>): RouteApi<TId, TRouter>;

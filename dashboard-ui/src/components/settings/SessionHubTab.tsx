          ...
          {showAdd && (
            <div className="border border-border/40 bg-surface p-4">
              <div className="grid grid-cols-1 gap-3 xl:grid-cols-3">
                <div>
                  <div className="text-[11px] font-bold uppercase tracking-wider text-muted-foreground mb-1">Provider Name</div>
              ...
              <div className="flex gap-2 mt-4">
                <Button size="sm" onClick={handleAdd} disabled={!newName || mutations.createProvider.isPending}>
                  {mutations.createProvider.isPending ? "Creating..." : "Create Provider"}
                </Button>
